...
const FrameFortyFourPage = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-end mx-auto w-full">
        <div className="h-[1251px] md:h-[697px] md:px-5 relative w-full">
          <div className="flex flex-col m-auto w-full">
            ...
            <div className="md:h-[321px] h-[769px] ml-auto mr-[235px] mt-[-215.87px] w-[46%] md:w-full z-[1]">
              <Img
          ...
          <div className="absolute flex flex-col items-center justify-start right-[2%] top-[12%] w-[27%]">
            <Img
...
export default FrameFortyFourPage;
